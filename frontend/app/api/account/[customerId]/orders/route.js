...
export async function GET(request, { params } = {}) {
    ...
    const customerIdFromPath = accountIndex >= 0 ? segments[accountIndex + 1] : undefined;
    ...
    try {
        const response = await fetch(`${backendUrl}/api/customers/${customerId}/orders`, { cache: "no-store" });
